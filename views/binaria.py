...
from models.binary import BinaryStructure


class BinariaContent(BaseContent):
    title = "B. Internas - Busqueda Binaria"

    def __init__(self, master):
        super().__init__(master)

        # Estado
        self.structure: Optional[BinaryStructure] = None
    ...
    def on_crear(self):
        ...
        try:
            ...
            return
        try:
            self.structure = BinaryStructure(10 ** exp, klen)
        except Exception as e:
            self._error(str(e))
            return
        self._set_estado("Estructura creada (ordenada).")
    ...
    def on_cargar(self):
        ...
        try:
            with open(path, "r", encoding="utf-8") as f:
                data = json.load(f)
            struct = BinaryStructure.from_dict(data)
        except Exception as e:
